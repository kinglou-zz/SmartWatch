...
// Onboard TF card (SPI) — Waveshare ESP32-S3-Touch-AMOLED-2.06 schematic J4
#define SDCARD_PIN_MOSI GPIO_NUM_1
#define SDCARD_PIN_SCK  GPIO_NUM_2
#define SDCARD_PIN_MISO GPIO_NUM_3
#define SDCARD_PIN_CS   GPIO_NUM_17
